...
<div class="container">
    ...
    <div class="row">
        ...
        <form class="form-inline" style="padding: 5px" method="GET" type="text" action="suprimmerVoiture.php">
            ...
            <input style="margin-left: 5px" type="text" name="immatriculationsuprimmer" class="form-control" placeholder="<-- Immatriculation">
        </form>
        <!--        Acceuil-->
        <form class="form-inline" style="margin-left: 25%"  method="GET" type="text" action="index.html">
    ...
    <div class="row">
        <div class="d-flex align-items-center" style="height: 100px;">
            ...
            <!--Recherche Modele -->
            <form method="GET" action="listeVoitureSearch.php" class="row" >
                ...
                <select name="modele" size="1">
                    ...
                    ?>
                    <input <button type="submit" name="recherche" class="btn btn-primary">
            </form>
    ...
    $connexion = new PDO('mysql:host=localhost;dbname=locauto',
        'root', '');
    $requete = 'SELECT id_voiture,immatriculation,compteur,id_modele,modele.libelle as libellemodele,id_categorie,image,categorie.libelle ,prix
FROM voiture join modele USING(id_modele) join categorie using (id_categorie)';
