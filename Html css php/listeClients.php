...
<div class="container">
    ...
    <div class="row">
        <!--  Ajouter un client -->
        <form class="form-inline" style="margin-left: 1.5%" method="GET" type="text" action="ajouterClient.php">
        ...
        <form class="form-inline" style="padding: 5px" method="GET" type="text" action="suprimmerClient.php">
            ...
            <input style="margin-left: 5px"  type="text" name="id_client_suprimmer" class="form-control" placeholder="<-- Numéro de client">
        </form>
<!--        Acceuil-->
...
$connexion = new PDO('mysql:host=localhost;dbname=locauto',
    'root', '');
$requete = 'SELECT nom,id_client,prenom,adresse, id_type_de_client,libelle
